    ...
    <>
      ...
      {copied && (
        <button
          ...
          className="fixed bottom-[66%] left-1/2 -translate-x-1/2 z-[300] bg-yellow-400 text-black px-5 py-3 rounded-full text-base font-black shadow-xl whitespace-nowrap border-2 border-black active:scale-95 transition-transform"
        >
