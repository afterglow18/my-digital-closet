 ...
 * premium entitlement. Pitches the 360° mannequin view and lets the user
 * choose between Monthly, Yearly, or Lifetime (which grants mannequin access).
 *
 * Design matches UpgradeSheet — plaid header, dark feature card, 3-plan cards.
 */
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto flex flex-col px-4 pt-4 pb-2 gap-4 min-h-0">
        ...
        <div className="rounded-2xl overflow-hidden flex flex-col" style={{ background: "#0a0a0a" }}>
          <div className="px-4 pt-4 pb-3">
            <p className="font-bold text-xs tracking-widest uppercase" style={{ color: "#F0C030" }}>
            ...
            return (
              ...
              >
                ...
                <span
                  ...
                  style={{ fontSize: "clamp(1.3rem, 6vw, 1.6rem)", color: "#0a0a0a" }}
                >
                  {p.price}
                </span>
                <span
                  ...
                  {p.bullets.map((b) => (
                    <div key={b.text} className="flex items-center gap-1">
                      ...
                      <span
                        ...
                        style={{ color: b.accent ? "#E09020" : (isLifetime ? "#0a0a0a" : "rgba(0,0,0,0.55)") }}
                      >
                        {b.text}
                      </span>
                    </div>
      ...
      >
        ...
        >
          ...
          {status !== "pending" && <span className="text-xl leading-none">›</span>}
        </button>
        <button
          onClick={onClose}
