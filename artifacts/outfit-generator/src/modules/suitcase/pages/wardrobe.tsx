...
import {
  useListOutfits, getListOutfitsQueryKey, useSaveOutfit,
} from "../hooks/useLocalOutfits";
import { X } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";
import { SuitcaseRow, SuitcaseRowHandle } from "../components/SuitcaseRow";
...
export default function WardrobePage() {
  ...
  const rowRefs: Record<RowKey, RefObject<SuitcaseRowHandle | null>> = {
    outfits:    useRef<SuitcaseRowHandle | null>(null),
    beauty:     useRef<SuitcaseRowHandle | null>(null),
    toiletries: useRef<SuitcaseRowHandle | null>(null),
    essentials: useRef<SuitcaseRowHandle | null>(null),
  };
  ...
  return (
    ...
    >
      ...
      <img
        src="/suitcase/suitcase-open-bg.jpg"
