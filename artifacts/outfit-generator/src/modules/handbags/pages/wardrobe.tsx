...
import { HandbagsRow, HandbagsRowHandle } from "../components/HandbagsRow";
...
export default function WardrobePage() {
  ...
  const rowRefs: Record<RowKey, RefObject<HandbagsRowHandle | null>> = {
    "totes":              useRef<HandbagsRowHandle | null>(null),
    "shoulder-bags":      useRef<HandbagsRowHandle | null>(null),
    "crossbody-bags":     useRef<HandbagsRowHandle | null>(null),
    "clutches-wristlets": useRef<HandbagsRowHandle | null>(null),
  };
