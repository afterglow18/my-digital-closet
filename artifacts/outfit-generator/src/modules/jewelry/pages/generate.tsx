...
import { JewelryRow, JewelryRowHandle } from "../components/JewelryRow";
...
export default function GeneratePage() {
  ...
  const rowRefs: Record<RowKey, RefObject<JewelryRowHandle | null>> = {
    rings:     useRef<JewelryRowHandle | null>(null),
    earrings:  useRef<JewelryRowHandle | null>(null),
    necklaces: useRef<JewelryRowHandle | null>(null),
    bracelets: useRef<JewelryRowHandle | null>(null),
  };
  ...
  return (
    ...
    >
      ...
      <img
        src="/jewelry/jewelry-box-bg.png"
                ...
                <React.Fragment key={key}>
                  ...
                  {items.length > 0 ? (
                    <div style={{
                      ...
                      width: carW, height: rowIdx === 0 ? consistentPhotoH * 0.90 : consistentPhotoH,
                      ...
                      <JewelryRow
                        ...
                        maxPhotoH={rowIdx === 0 ? consistentPhotoH * 0.90 : consistentPhotoH}
                        disableSwipe
                      />
                    </div>
                  ) : (
