/**
 * JewelryRow — fixed 3-slot carousel for the wardrobe closet view.
 *
...
// ── Types ─────────────────────────────────────────────────────────────────────
export interface JewelryRowHandle {
  scrollToIndex: (index: number, smooth?: boolean) => void;
  getLength: () => number;
}

interface JewelryRowProps {
  items: ClothingItem[];
...
// ── Component ─────────────────────────────────────────────────────────────────
export const JewelryRow = forwardRef<JewelryRowHandle, JewelryRowProps>(
        ...
        >
          {items.slice(lo, hi + 1).map((item, localIdx) => {
            ...
            if (transitioning) {
              ...
              bg      = p > 0.5 ? `rgba(22, 5, 32, ${((p - 0.5) * 2).toFixed(3)})` : "transparent";
              shadow  = p > 0.05
...
JewelryRow.displayName = "JewelryRow";
