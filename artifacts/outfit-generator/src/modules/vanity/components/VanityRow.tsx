/**
 * VanityRow — fixed 3-slot carousel for the wardrobe closet view.
 *
...
// ── Types ─────────────────────────────────────────────────────────────────────
export interface VanityRowHandle {
  scrollToIndex: (index: number, smooth?: boolean) => void;
  getLength: () => number;
}

interface VanityRowProps {
  items: ClothingItem[];
...
// ── Component ─────────────────────────────────────────────────────────────────
export const VanityRow = forwardRef<VanityRowHandle, VanityRowProps>(
...
VanityRow.displayName = "VanityRow";
