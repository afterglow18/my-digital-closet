...
import { VanityRow, VanityRowHandle } from "../components/VanityRow";
...
export default function GeneratePage() {
  ...
  const rowRefs: Record<RowKey, RefObject<VanityRowHandle | null>> = {
    makeup:     useRef<VanityRowHandle | null>(null),
    skincare:   useRef<VanityRowHandle | null>(null),
    hair:       useRef<VanityRowHandle | null>(null),
    fragrances: useRef<VanityRowHandle | null>(null),
  };
  ...
  return (
    ...
    >
      ...
      <img
        src="/vanity/generate-bg.png?v=2"
