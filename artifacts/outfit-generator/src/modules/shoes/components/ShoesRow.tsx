/**
 * ShoesRow — fixed 3-slot carousel for the wardrobe closet view.
 *
...
// ── Types ─────────────────────────────────────────────────────────────────────
export interface ShoesRowHandle {
  scrollToIndex: (index: number, smooth?: boolean) => void;
  getLength: () => number;
}

interface ShoesRowProps {
  items: ClothingItem[];
...
// ── Component ─────────────────────────────────────────────────────────────────
export const ShoesRow = forwardRef<ShoesRowHandle, ShoesRowProps>(
